...
**References**:
 - Documentation: [Customize your status line](https://code.claude.com/docs/en/statusline)
...
**Differences between `settings.json` and `settings.local.json`**
...
**Why are these disabled or excluded?**

| Configuration | What it is | Why | 
|--|--|--|
